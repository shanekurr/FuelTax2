            ...
            <tbody>
                @For Each item As CChartData In Model
                    @<tr>
                        ...
                        <td>
                            @Html.DisplayFor(Function(modelItem) item.oldVal)
                        </td>
                        <td>
                            @Html.DisplayFor(Function(modelItem) item.newVal)
                        </td>
                    </tr>
                Next
            </tbody>
...
<script class="code" type="text/javascript">
    $(function () {
        $('#chart1').highcharts({
            ...
            title: {
                text: 'DMV Gasoline Tax Revenue Distribution to Highway Fund'
            },
            yAxis: {
                min: 0,
                title: {
