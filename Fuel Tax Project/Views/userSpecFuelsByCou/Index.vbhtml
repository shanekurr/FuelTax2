...
<div class="row-fluid">
    <div class="span12">
        ...
        <div class="span3">
            @Using Html.BeginForm("Chart1", "userSpecFuelsByCou", method:=FormMethod.Post)
                @Html.ValidationSummary(True)
                @<fieldset>
                    <legend>Special Fuel Gallons By County </legend>
                    <div class="row-fluid">
                        <div class="span12">
        ...
        <div class="span4">
            @Using Html.BeginForm("Chart2", "userSpecFuelsByCou", method:=FormMethod.Post)
                @Html.ValidationSummary(True)
                @<fieldset>
        ...
        <div class="span4">
            @Using Html.BeginForm("Chart3", "userSpecFuelsByCou", method:=FormMethod.Post)
                @Html.ValidationSummary(True)
                @<fieldset>
                    <legend>Special Fuel Gallons By Years and County</legend>
                    <div class="row-fluid">
                        <div class="span6">
                            <p>Please Select A County</p>
                            <div class="span6">
