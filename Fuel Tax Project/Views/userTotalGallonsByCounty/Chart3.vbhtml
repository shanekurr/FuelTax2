...
@Code
    ViewData("Title") = "Total Gallons by County for Range of Years"
End Code

<h2>Total Gallons by County for Range of Years</h2>
...
<script class="code" type="text/javascript">
    $(function () {
        $('#container').highcharts({
            ...
            title: {
                text: 'Total Gallons by County for Range of Years'
            },
            yAxis: {
                min: 0,
                title: {
      ...
      $(document).ready(function () {
        var s2 = [
            ...
            @For Each v As CChartData  In Model
                @String.Format("[{0}, {1}], ", v.ValueS2, v.ValueS1)
            Next
        ];
