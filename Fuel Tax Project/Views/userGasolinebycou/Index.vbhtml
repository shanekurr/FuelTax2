...
@Code
    ViewData("Title") = "Total Gasoline By County"
End Code

<div class="row-fluid">
    <div class="span12">
        <h2>Total Gasoline By County</h2>
    </div>
    <div class="span3">
    @Using Html.BeginForm("Chart1", "userGasolinebycou", method:=FormMethod.Post)
...
<div class="span4">
    @Using Html.BeginForm("Chart2", "userGasolinebycou", method:=FormMethod.Post)
    @Html.ValidationSummary(True)
            @<fieldset>
    ...
    <div class="span4">
            @Using Html.BeginForm("Chart3", "userGasolinebycou", method:=FormMethod.Post)
            @Html.ValidationSummary(True)
            @<fieldset>
