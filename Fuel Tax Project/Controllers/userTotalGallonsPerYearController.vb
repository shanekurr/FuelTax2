...
Namespace Fuel_Tax_Project
    Public Class userTotalGallonsPerYearController
        Inherits System.Web.Mvc.Controller

        Private db As New fueltaxEntities

        ' GET: /userTotalGallonsPerYear/
        ...
        ' GET: /userTotalGallonsPerYear/Details/5
        ...
        Function Chart(ed1 As DropDownData) As ActionResult
            ...
            Dim valQ = From y In db.gasvsgasoholes
                        ...
                        Select y.year, y.total
                        Order By year

            For Each k In valQ
                List.Add(New CChartData With {.Year = k.year, .ValueS1 = k.total})
            Next
