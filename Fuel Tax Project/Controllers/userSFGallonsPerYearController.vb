...
Namespace Fuel_Tax_Project
    Public Class userSFGallonsPerYearController
        Inherits System.Web.Mvc.Controller

        Private db As New fueltaxEntities

        ' GET: /userSFGallonsPerYear/
        ...
        ' GET: /userSFGallonsPerYear/Details/5
        ...
        Function Chart(ed1 As DropDownData) As ActionResult
            ...
            Dim valQ = From y In db.gasvsgasoholes
                        ...
                        Select y.year, y.gasohole
                        Order By year

            For Each k In valQ
                List.Add(New CChartData With {.Year = k.year, .ValueS1 = k.gasohole})
            Next
